...
export default function FavoritesBar() {
  ...
  const sendToWhatsApp = (store: StoreName) => { window.open(whatsappUrl(storeDetails[store].phone, favoriteMessage(favorites.map((favorite) => ({ name: favorite.name, sku: favorite.sku })))), "_blank", "noopener,noreferrer"); setStoreChoiceOpen(false); };
