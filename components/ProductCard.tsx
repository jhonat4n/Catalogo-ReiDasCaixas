...
export default function ProductCard({ product, storePhones }: ProductCardProps) {
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-dourado/30">
      <div className="relative"><ImagePlaceholder image={image} alt={product.nome} sizes="(max-width: 768px) 100vw, 33vw" className="rounded-none" /><div className="absolute right-3 top-3"><FavoriteButton product={product} compact /></div></div>
